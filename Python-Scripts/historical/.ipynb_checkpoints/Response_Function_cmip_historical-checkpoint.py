"""
This script can be used to create response function in SST and heat content due to single NAO event using cmip historical runs. 
"""
...
for model in source_id:
    ...
    for dir1 in dir_list:
        ...
        for cas in case:
            ...
            d1 = xr.open_dataset(ppdir + model + exp + "/" + dir_name + "/" + cas + 
                                 "_Composite_Heat_Content_SST_NAO.nc", use_cftime=True)

            print(dir_name, cas, ind_check, len(d1['r']))
    ...
    save_file_path = (ppdir + model + exp + "/Response_Function_Heat_Content_SST_NAO.nc")
