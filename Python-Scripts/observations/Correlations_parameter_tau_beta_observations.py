"""
This script uses an analytical response function (SST and heat content change due to single NAO event) with NAO timeseris from HadSLP data  to preditc the actual 
...
#ds_mov = Moving_Avg(ds_mov, time = ds_mov['time'], time_len = mov_avg)
